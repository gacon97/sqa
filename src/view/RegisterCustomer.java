...
//        Date date_cmnd  = (Date) date.getDate();
        User user = new User(txtName.getText(), txtEmail.getText(), jboxSex.getSelectedItem().toString() ,txtPhone.getText(), txtCardId.getText(), txtPlaceCard.getText(), date_cmnd);
        RegisterController register = new RegisterController();
        
        boolean check = register.save(user);
